...
% legend('$V_{G}$ = 2.5V', '$V_{G}$ = 3.5V', '$V_{G}$ = 4.5V', 'interpreter', 'latex',Location='best');
% grid on
...
xlabel('$V_{DS}$ (in V)', 'interpreter', 'latex');
ylabel('$I_{DS}$ (in A)', 'interpreter', 'latex');
title(['IV characteristics for $t_{ox}$ = ', num2str(tox*1e9), ' nm, L = ', num2str(L*1e6),' $\mu$m'], 'interpreter', 'latex');
legend('$V_{G}$ = 2.5V', '$V_{G}$ = 3.5V', '$V_{G}$ = 4.5V','$V_{G}$ = 2.5V (Vertical)', '$V_{G}$ = 3.5V (Vertical)', '$V_{G}$ = 4.5V (Vertical)', 'interpreter', 'latex', Location='best');
grid on
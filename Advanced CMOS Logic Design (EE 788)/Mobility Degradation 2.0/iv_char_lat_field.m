...
% title(['Constant Mobility IV characteristics for $t_{ox}$ = ', num2str(tox*1e9), ' nm, L = ', num2str(L*1e6),' $\mu$m'], 'interpreter', 'latex');
% legend('$V_{G}$ = 2.5V (Constant $\mu$)', '$V_{G}$ = 3.5V (Constant $\mu$)', '$V_{G}$ = 4.5V (Constant $\mu$)', 'interpreter', 'latex', Location='best');
% grid on
...
% xlabel('$V_{DS}$ (in V)', 'interpreter', 'latex');
% ylabel('$I_{DS}$ (in mA)', 'interpreter', 'latex');
% title(['Vertical Field induced Mobility Degradation IV characteristics for $t_{ox}$ = ', num2str(tox*1e9), ' nm, L = ', num2str(L*1e6),' $\mu$m'], 'interpreter', 'latex');
...
% xlabel('$V_{DS}$ (in V)', 'interpreter', 'latex');
% ylabel('$I_{DS}$ (in mA)', 'interpreter', 'latex');
% title(['Lateral + Vertical Field induced Mobility Degradation IV characteristics for $t_{ox}$ = ', num2str(tox*1e9), ' nm, L = ', num2str(L*1e6),' $\mu$m'], 'interpreter', 'latex');
% legend('$V_{G}$ = 2.5V (Lateral + Vertical)', '$V_{G}$ = 3.5V (Lateral + Vertical)', '$V_{G}$ = 4.5V (Lateral + Vertical)', 'interpreter', 'latex', Location='best');
